import { Heart, Shield, Home, Users, Section, Coins } from "lucide-react";
...
export default function ContentSection({volunteer, donation,  rescue_case, rescueMission}:DonationProp) {
    const stats = [
        { number: "?+", label: "Animals Rescued", icon: Heart },
        { number: "?%", label: "Donation Amount", icon: Coins },
        { number: "?+", label: "Completed Rescue Cases", icon: Home },
            ...
            <div className="container mx-auto px-4">
                ...
                <div  className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                    {stats.map((stat, index) => (
                        <div key={index}  className="bg-card rounded-2xl p-6 md:p-8 shadow-card text-center group hover:shadow-elevated transition-shadow">
