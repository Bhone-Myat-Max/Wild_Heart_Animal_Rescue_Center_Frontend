...
export default {
    ...
    create: ( data : FormData ) => axios.post<HTTPResponse<User[]>>(route.resource, data ),
    ...
    updateProfile: (data : FormData) => axios.put<HTTPResponse<UpdatePayload[]>>('user/update-profile' , data )
}